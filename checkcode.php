...
//创建图片
$im=@imagecreatetruecolor(70,30)or die("Cannot Initialize new GD image stream");//创建图片
...
for($i=0;$i<rand(0,50);$i++){//添加干扰线条
	
   $text_color2=imagecolorallocate($im,rand(100,200),rand(100,200),rand(100,200));
   imageline($im,rand(0,70),rand(0,30),rand(0,70),rand(0,30),$text_color2);
}
for($i=0;$i<rand(100,600);$i++){//添加干扰像素
	 $text_color3=imagecolorallocate($im,rand(100,200),rand(100,200),rand(100,200));
	 imagesetpixel($im,rand(0,70),rand(0,30),$text_color3);
	}
imagestring($im,6,rand(0,20),rand(0,5),$code,$text_color);//将文字写在图片上
